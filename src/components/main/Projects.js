      ...
      <section id="projects" className="py-5">
        <div className="container">
          ...
          <div className="row text-center mt-5">
            {this.state.projects.map(project => <Project key={project.id} img={project.img} heading={project.heading} desc={project.desc} url={project.url} github_url={project.github_url} />)}
          </div>
